...
state = Random( 1, 3 )
    ...
    if (state == 1) then
        ComponentSetValue2( comp, "attack_ranged_entity_file", "mods/mo_creeps/files/entities/projectiles/musical_attack_shotgun_homing.xml" )
    ...
    elseif (state == 2) then
        ...
        ComponentSetValue2( comp, "attack_ranged_entity_file", "mods/mo_creeps/files/entities/projectiles/summon_musical_being_bighp.xml" )
