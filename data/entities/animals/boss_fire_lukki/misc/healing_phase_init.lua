...
if ( comp ~= nil ) then
	ComponentObjectSetValue2( comp, "damage_multipliers", "melee", -0.3 )
	...
	ComponentObjectSetValue2( comp, "damage_multipliers", "slice", -0.3 )
	ComponentObjectSetValue2( comp, "damage_multipliers", "ice", -0.3 )
	ComponentObjectSetValue2( comp, "damage_multipliers", "curse", -0.3 )
