...
function item_pickup( entity_item, entity_who_picked, name )
	...
	CreateItemActionEntity( "MOCREEPS_PORTAL_LUKKI_RED_PORTAL", pos_x - 16, pos_y )
	CreateItemActionEntity( "MOCREEPS_PORTAL_LUKKI_GREEN_PORTAL", pos_x, pos_y )
	CreateItemActionEntity( "MOCREEPS_PORTAL_LUKKI_BLUE_PORTAL", pos_x + 16, pos_y )
