...
function material_area_checker_success( pos_x, pos_y )
    ...
    if HasFlagPersistent( "mocreeps_card_unlocked_secret_knowledge_of_kings" ) ~= true then
        EntityLoad( "mods/mo_creeps/files/entities/items/orbs/orb_divine_cape_unlock.xml", pos_x - 1, pos_y )
        ...
        EntityLoad( "mods/mo_creeps/files/entities/items/orbs/orb_divine_heart.xml", pos_x - 1, pos_y )
        EntitySetComponentsWithTagEnabled(entity_id, "enabled_by_liquid", true)
        EntitySetComponentsWithTagEnabled(entity_id, "disabled_by_liquid", false)
    end
