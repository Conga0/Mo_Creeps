...
local enemy_list = { "gazer_greater", "devourer_magic", "devourer_ghost", "crypt/hideous_mass", "gazer_cold_mocreep", "crypt/tentacler_big", }
...
if target == "gazer_cold_mocreep" then count = 4 end
