local ModEnabledCTEP = ModIsEnabled("Conga_Twitch_mod")
    ...
    table.insert(streaming_events,
	{
		...
		ui_name = "$integration_mocreep_RANDOM_CATS_name",
		ui_description = "$integration_mocreep_RANDOM_CATS_desc",
    ...
    table.insert(streaming_events,
	{
		...
		ui_name = "$integration_mocreep_RANDOM_CREEPS_name",
		ui_description = "$integration_mocreep_RANDOM_CREEPS_desc",
		ui_icon = "data/ui_gfx/streaming_event_icons/health_plus.png",
		ui_author = "Conga Lyne - Mo Creeps",
		weight = 1.0,
    ...
    table.insert(streaming_events,
	{
		...
		ui_name = "$integration_mocreep_WAND_WONDERS_name",
		ui_description = "$integration_mocreep_WAND_WONDERS_desc",
		ui_icon = "data/ui_gfx/streaming_event_icons/health_plus.png",
		ui_author = "Conga Lyne - Mo Creeps",
		weight = 0.8,
    ...
    table.insert(streaming_events,
	{
		...
		ui_name = "$integration_mocreep_PANDORA_CHEST_name",
		ui_description = "$integration_mocreep_PANDORA_CHEST_desc",
		ui_icon = "data/ui_gfx/streaming_event_icons/health_plus.png",
		ui_author = "Conga Lyne - Mo Creeps",
		weight = 0.75,
		kind = STREAMING_EVENT_BAD,
    ...
    table.insert(streaming_events,
	{
		...
		ui_name = "$integration_mocreep_RANDOM_CREEPS_BOSS_name",
		ui_description = "$integration_mocreep_RANDOM_CREEPS_BOSS_desc",
		ui_icon = "data/ui_gfx/streaming_event_icons/health_plus.png",
		ui_author = "Conga Lyne - Mo Creeps",
		weight = 0.1,
    ...
    table.insert(streaming_events,
	{
		...
		ui_name = "$integration_mocreep_STONE_FUNGUS_name",
		ui_description = "$integration_mocreep_STONE_FUNGUS_desc",
		ui_icon = "data/ui_gfx/streaming_event_icons/health_plus.png",
		ui_author = "Conga Lyne - Mo Creeps",
		weight = 0.8,
		kind = STREAMING_EVENT_GOOD,
    ...
    table.insert(streaming_events,
	{
		...
		ui_name = "$integration_mocreep_CREATURE_SHIFT_name",
		ui_description = "$integration_mocreep_CREATURE_SHIFT_desc",
		ui_icon = "data/ui_gfx/streaming_event_icons/health_plus.png",
		ui_author = "Conga Lyne - Mo Creeps",
		weight = 1.0,
		kind = STREAMING_EVENT_AWFUL,
    ...
    table.insert(streaming_events,
	{
		...
		ui_name = "$integration_mocreep_TRANSFORM_WORMS_name",
		ui_description = "$integration_mocreep_TRANSFORM_WORMS_desc",
	...
	{
		id = "MOCREEP_MUD_MEN",
		ui_name = "$integration_mocreep_MUD_MEN_name",
		ui_description = "$integration_mocreep_MUD_MEN_desc",
		ui_icon = "data/ui_gfx/streaming_event_icons/health_plus.png",
		ui_author = "Conga Lyne - Mo Creeps",
		weight = 0.75,
		kind = STREAMING_EVENT_GOOD,
    ...
    table.insert(streaming_events,
	{
		...
		ui_name = "$integration_mocreep_SUMMON_SKOUDE_name",
		ui_description = "$integration_mocreep_SUMMON_SKOUDE_desc",
		ui_icon = "data/ui_gfx/streaming_event_icons/health_plus.png",
		ui_author = "Conga Lyne - Mo Creeps",
		weight = 0.4,
		kind = STREAMING_EVENT_AWFUL,
