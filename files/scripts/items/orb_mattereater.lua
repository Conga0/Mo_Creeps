	...
	if ( comp ~= nil ) then
		...
		if ( count > 9 ) then
            ...
            for i=1,how_many do
                ...
                shoot_projectile( entity_id, "mods/mo_creeps/files/entities/projectiles/mass_status_mattereater_effect.xml", x, y, vel_x, vel_y )
            end
            ...
            for i,v in ipairs( targets ) do
                if ( v ~= entity_id ) then
                    ...
                    if EntityHasTag(v, "hittable") then
                        local eid = EntityLoad( "mods/mo_creeps/files/entities/misc/effect_status_mattereater.xml", x, y )
