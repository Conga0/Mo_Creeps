...
if (lootSeed >= 96) then
	EntityLoad( "mods/mo_creeps/files/entities/items/pickups/chest_random_cursed.xml", pos_x, pos_y )
...
elseif (lootSeed >= 50) then
	EntityLoad( "mods/mo_creeps/files/entities/items/pickups/orb_mattereater.xml", pos_x, pos_y )
else
