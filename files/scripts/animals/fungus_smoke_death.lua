...
function death( damage_type_bit_field, damage_message, entity_thats_responsible, drop_items )
	...
	EntityLoad( "mods/mo_creeps/files/entities/projectiles/fungus_tiny_explosion.xml", pos_x, pos_y )
	...
	for i=1,how_many do
		...
		shoot_projectile( entity_id, "mods/mo_creeps/files/entities/projectiles/fungus_smoke_maker.xml", pos_x, pos_y, vel_x, vel_y )
	end
