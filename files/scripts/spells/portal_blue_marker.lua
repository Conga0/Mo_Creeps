...
if GameGetFrameNum() >= cooldown_frame then
    if ComponentGetValue2(controlscomp, "mButtonDownRightClick") then
        GameShootProjectile(root, x+aim_x*12, y+aim_y*12, x+aim_x*20, y+aim_y*20, EntityLoad("mods/mo_creeps/files/entities/projectiles/deck/markerportals/portal_blue_marker.xml", x, y))
