...
for i=1,how_many do
	...
	shoot_projectile( entity_id, "mods/mo_creeps/files/entities/projectiles/deck/mass_status_drunk_effect.xml", pos_x, pos_y, vel_x, vel_y )
end
...
for i,v in ipairs( targets ) do
	if ( v ~= entity_id ) then
		...
		if valid and EntityHasTag(v, "hittable") then
			local eid = EntityLoad( "mods/mo_creeps/files/entities/misc/effect_status_drunk.xml", pos_x, pos_y )
