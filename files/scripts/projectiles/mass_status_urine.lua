...
for i=1,how_many do
	...
	shoot_projectile( entity_id, "mods/mo_creeps/files/entities/projectiles/deck/mass_status_urine_effect.xml", pos_x, pos_y, vel_x, vel_y )
end
	...
	if ( v ~= entity_id ) then
		...
		if ( c ~= nil ) then
			for a,b in ipairs( c ) do
				local comps = EntityGetComponent( b, "GameEffectComponent", "effect_urine_magic" )
