...
for i=1,count do
	...
	shoot_projectile_from_projectile( entity_id, "mods/mo_creeps/files/entities/projectiles/enlightened_laser_iceball.xml", px + Random( -5, 5 ), py + Random( -5, 5 ), vel_x, vel_y )
end
