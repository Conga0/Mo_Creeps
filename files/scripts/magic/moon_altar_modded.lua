...
dofile_once("mods/mo_creeps/files/scripts/magic/fungal_shift_spam.lua")
...
if essence_6 and ( #players_ == 0 ) and ( #sun == 0 ) and ( #sun2 == 0 ) then
	...
	if do_effect then
		...
		if essence_6 then
			EntityLoad("mods/mo_creeps/files/scripts/essence/moon_effect_fungus.xml", x, y)
			...
			local cid = EntityLoad("mods/mo_creeps/files/entities/misc/essence/moon_fungus_curse.xml", x, y)
