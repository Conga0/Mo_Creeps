	...
	},
	{
		...
		function( entity_id )
			...
			if ( sprites ~= nil ) and ( sprites[2] ~= nil ) then
				...
				ComponentSetValue2( v, "image_file", "mods/mo_creeps/files/particles/enlightened_alchemist_halo_heal.xml" )
			end
		end,
	},
	{
		...
		function( entity_id )
			...
			if ( animalais ~= nil ) then
				for i,v in ipairs( animalais ) do
					ComponentSetValue2( v, "attack_ranged_entity_file", "mods/mo_creeps/files/entities/projectiles/enlightened_laser_ice_wand.xml" )
				end
			end
			...
			if ( sprites ~= nil ) and ( sprites[2] ~= nil ) then
				...
				ComponentSetValue2( v, "image_file", "mods/mo_creeps/files/particles/enlightened_alchemist_halo_ice.xml" )
			end
		end,
	},
}
