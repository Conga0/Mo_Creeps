...
if mocreep_blob_dead_goldmode then
    entity = EntityLoad( "mods/mo_creeps/files/entities/props/goldmode/statue_blob_titan.xml", 4312, 2115 )
elseif mocreep_blob_dead then
    entity = EntityLoad( "mods/mo_creeps/files/entities/props/statue_blob_titan.xml", 4312, 2115 )
else
    entity = EntityLoad( "mods/mo_creeps/files/entities/props/statue_empty.xml", 4312, 2115 )
end
